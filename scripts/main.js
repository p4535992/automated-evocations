            ...
            fn: async (template,tokenData) => {
                ...
                await new Sequence()
                    .effect()
                        ...
                        .wait(650)
                    .effect()
                        .file("modules/automated-evocations-variant/assets/animations/JB2A/IceSpikesRadialBurst_01_Regular_White_1000x1000.webm")
                        .randomRotation()
                        .atLocation(template)
                        .scale(Math.max(tokenData.width,tokenData.height)*tokenData.scale*0.55)
                .play()
            ...
            fn: async (template,tokenData) => {
                ...
                await new Sequence()
                    .effect()
                        ...
                        .wait(100)
                    .effect()
                        .file("modules/automated-evocations-variant/assets/animations/JB2A/BardicInspiration_01_Regular_GreenOrange_400x400.webm")
                        .atLocation(template)
                        .scale(Math.max(tokenData.width,tokenData.height)*tokenData.scale*0.45)
                .play()
            },
