...
export class AutomatedEvocationsCustomBindings extends FormApplication {
	constructor() {
		super();
	}
	...
	static get defaultOptions() {
		return {
			...
			template: `modules/${CONSTANTS.MODULE_NAME}/templates/custombindings.hbs`,
			resizable: true,
			width: 300,
...
export class AutomatedEvocationsCustomBindingsConfig extends FormApplication {
	constructor(binding) {
		super();
	...
	static get defaultOptions() {
		return {
			...
			template: `modules/${CONSTANTS.MODULE_NAME}/templates/custombindingconfig.hbs`,
			resizable: true,
			width: 300,
			height: window.innerHeight > 400 ? 400 : window.innerHeight - 100,
			dragDrop: [{ dragSelector: null, dropSelector: null }],
